                                        ...
                                        con.query(sql, function (err, result4) {
                                          ...
                                          con.query(sql, function (err, result5) {
                                            if (err) throw err;
                                              ...
                                              client.query("INSERT INTO requests SET (requests_type, sender_address, receiver_address, amount, datetime, uid, hash) VALUES (0, '"+sender+"', '"+receiver+"', "+amount.toFixed(2)+", NOW(), "+req.body.uid+", '"+hash+"')");
